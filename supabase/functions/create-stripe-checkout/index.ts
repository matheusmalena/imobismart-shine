...
serve(async (req) => {
  ...
  try {
    ...
    const origin = req.headers.get("origin") || "https://imobismart-shine.lovable.app";
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "subscription",
      success_url: `${origin}/plans?status=success&plan=${planId}`,
      cancel_url: `${origin}/plans?status=cancelled`,
